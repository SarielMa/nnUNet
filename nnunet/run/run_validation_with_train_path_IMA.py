...
def main(noise, filename, taskid, attack):
...
if __name__ == "__main__":
    ...
    netDict = [["IMAN20D5", "PGD25","PGD15","PGD5","STD"],#D2
                ["IMAN15D2","PGD15","PGD10","PGD5","PGD1","STD"],#D4
                ["IMAN40D10","PGD40","PGD20","PGD10","STD"],#D5
    ...
    #D2
    folders2 = ["D2_IMA/model_IMA002_N_20_D_5_final_checkpoint.model",               
               "D2_IMA/model_PGD25_final_checkpoint.model",
               "D2_IMA/model_PGD15_final_checkpoint.model",
               "D2_IMA/model_PGD5_final_checkpoint.model",
               "D2_IMA/model_final_checkpoint.model"]
    #D4   
    folders4 = [
               "D4_IMA/model_IMA004_N_15_D_2.0_final_checkpoint.model",
               "D4_IMA/model_PGD15_final_checkpoint.model",
               "D4_IMA/model_PGD10_final_checkpoint.model",
               "D4_IMA/model_PGD5_final_checkpoint.model",
               "D4_IMA/model_PGD1_final_checkpoint.model",
               "D4_IMA/model_final_checkpoint.model"
               ]
    #D5   
    folders5 = [ "D5_IMA/model_IMA005_N_40_D_10_final_checkpoint.model", 
                "D5_IMA/model_PGD40_final_checkpoint.model",                                                  
               "D5_IMA/model_PGD20_final_checkpoint.model",
               "D5_IMA/model_PGD10_final_checkpoint.model",
               "D5_IMA/model_final_checkpoint.model"]  
    ...
    for i, net in enumerate(nets):
        ...
        for noise in noises:
            vixelDice,avgDice = main(noise, join(basePath, folders[i]), selected[4:7], attack) 
    ...
    ax.legend()
    ax.grid(True)
    fig.savefig(attack+"VixelDice_result_"+selected+".pdf",bbox_inches='tight')
    
    with open(attack+"VixelDice_result_"+selected+".csv",'w') as csvfile:
    ...
    ax2.legend()
    ax2.grid(True)
    fig2.savefig(attack+"AVG_Dice_result_"+selected+".pdf",bbox_inches='tight')    

    with open(attack+"AVG_Dice_result_"+selected+".csv",'w') as csvfile:
        csvwriter = csv.writer(csvfile)
        csvwriter.writerow(fields)
